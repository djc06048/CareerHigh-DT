...
prs.save(r"/Users/hyelim/개인공부/2024-CareerHigh-DT/study/week4/class/test_ppt.pptx") #파워포인트 저장
...
prs.save(r"/Users/hyelim/개인공부/2024-CareerHigh-DT/study/week4/class/test_ppt1.pptx") #파워포인트 저장
...
# 저장
prs.save(r'/Users/hyelim/개인공부/2024-CareerHigh-DT/study/week4/class/test_ppt1.pptx')
...
img_path = r'/Users/hyelim/개인공부/velog/photo/e0feb32ca6814cefbb692f66ab1e5777.jpeg'
...
smtp_info = dict({"smtp_server" : "smtp.naver.com", # SMTP 서버 주소
                  "smtp_user_id" : "sanguk7664@naver.com", #개인 이메일주소 xxx@naver.com
                  "smtp_user_pw" : "dbzpdlclf!" , #naver 비밀번호
...
msg['From'] = "sanguk7664@naver.com"       # 송신자
msg['To'] = "sanguk7664@naver.com"     # 수신자
...
with open(r'C:/Users/SANGUK/Desktop/temp/test_img.PNG', 'rb') as fp:
...
with open(r'C:/Users/SANGUK/Desktop/temp/test_ppt.pptx', 'rb') as fp:
    msg = MIMEBase('application',  _subtype='octect-stream')
    msg.set_payload(fp.read())
    encoders.encode_base64(msg)
...
multi['from'] ="sanguk7664@naver.com"
multi['to'] = "sanguk7664@naver.com" 
server = smtplib.SMTP(smtp_info["smtp_server"], smtp_info["smtp_port"])
server.starttls()
server.login(smtp_info["smtp_user_id"], smtp_info["smtp_user_pw"])
